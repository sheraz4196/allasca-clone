...
const Contact = ({
  ...
  const handleButtonClick = (buttonText: string) => {
    trackButtonClick(
      buttonText,
      `${formId}-${buttonText.toLowerCase().replace(/\s+/g, "-")}`
    );
  };
  ...
  if (formOnly) {
    return (
      <form
        ...
        method="POST"
      >
        <h3 className="text-2xl font-sans font-bold text-casa-navy mb-6">
          Get Your Free Quote
        </h3>
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-center text-casa-gray">
            ...
            to being contacted about our services.
          </p>
        </div>
      </form>
    );
      ...
      <div className="container">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="animate-on-scroll">
            <h2 className="text-3xl md:text-4xl font-sans font-bold text-casa-navy mb-6">
              Ready to Transform Your Home?
            </h2>
            <p className="text-lg text-casa-gray mb-8">
              Get in touch with our team for a free consultation and estimate.
              We'd love to hear about your project and help you bring your
              vision to life.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-casa-gray">
                    7299 Yonge St, Thornhill, ON L3T 0C5
                  </p>
                </div>
              </div>
            </div>
