    ...
    <section id="services" className="py-20 bg-gradient-to-br from-white to-purple-50">
      <div className="container">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-poppins font-bold heading-gradient mb-4">Our Expert Services</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            From initial design to final finishing touches, we offer comprehensive home services designed to bring your vision to life.
          </p>
        </div>
          ...
          {serviceItems.map((service, index) => (
            ...
            >
              <CardContent className="p-6 flex flex-col items-center text-center h-full">
                ...
                <h3 className="text-xl font-bold font-poppins mb-3 text-gray-800">{service.title}</h3>
              </CardContent>
            </Card>
          ))}
        </div>
